...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-Insider 3/ActionKit.framework"
  install_framework "Pods-Insider 3/Alamofire.framework"
  install_framework "Pods-Insider 3/Charts.framework"
  install_framework "Pods-Insider 3/Gloss.framework"
